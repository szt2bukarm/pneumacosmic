...
export default function Page() {
    ...
    <div className="relative w-screen min-h-screen bg-black overflow-x-hidden">
        ...
        <div className="w-full h-full py-[200px] flex items-center justify-center">
        ...
        <div className="w-full h-full py-[155px] flex items-center justify-center">
        ...
        <div
            className="relative w-full h-[800px] mt-[140px] flex items-center justify-center"
            >
            ...
            <div className="w-full h-full py-[220px] flex items-center justify-center">
