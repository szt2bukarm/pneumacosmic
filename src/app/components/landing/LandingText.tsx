...
export default function LandingText() {
    ...
    return (
        <div className="mt-[100vh] relative w-screen h-fit py-[20px] md:py-[100px] xl:py-[120px flex items-center justify-center flex-col gap-[85px] z-10">
            <p data-gsap="landing-text" className="leading-[135%] font-gara text-middark text-lg md:text-h4 w-[90vw] xl:w-[1050px]">
            ...
            <p data-gsap="landing-text" className="leading-[135%] font-gara text-middark text-lg md:text-h4 w-[90vw] xl:w-[1050px]"><span className="opacity-50">A konceptualista, efemer művekből<br></br>felépülő kiállítás</span> öt elemre osztható: </p>
