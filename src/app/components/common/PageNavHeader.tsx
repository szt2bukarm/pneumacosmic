...
export default function PageNavHeader() {
    ...
    return (
    <div className={`flex w-screen items-center lg:justify-center fixed h-[200px] bg-gradient-to-b ${pathname === "/exhibition-4" ? "from-transparent   " : "from-black"} to-transparent top-0 left-0 z-[49]`}>
